...
namespace Online_Hostel_Management_System.Models
{
    ...
    partial void Onstd_imgChanging(string value);
    partial void Onstd_imgChanged();
    #endregion
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_std_img", DbType="NVarChar(MAX)")]
		public string std_img
		{
			get
			{
				return this._std_img;
			}
			set
			{
				if ((this._std_img != value))
				{
					this.Onstd_imgChanging(value);
					this.SendPropertyChanging();
					this._std_img = value;
					this.SendPropertyChanged("std_img");
					this.Onstd_imgChanged();
				}
			}
		}
